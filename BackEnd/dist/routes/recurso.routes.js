...
router.get("/candidato/:candidatoId/avaliador/:avaliadorId", authMiddleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield recurso_controller_1.default.listarQuesitosAvaliados(req, res);
}));
