...
export async function seedPrendas(prisma: PrismaClient) {
  // =====================================================
  // BLOCOS
  // =====================================================
  ...
  const culinaria = await prisma.quesitos.create({
    data: {
      nomeQuesito: "Culinária",
      notaMaximaQuesito: 6,
      opcional: false,
      blocoProvaIdBloco: blocoDotes.idBloco,
    },
  });
  ...
  await prisma.subQuesitos.createMany({
    data: [
      {
        nomeSubquesito: "Domínio da técnica da culinária",
        notaSubequesito: 2,
        quesitoId: culinaria.idQuesito,
      },
      {
        nomeSubquesito: "Execução",
        notaSubequesito: 2,
      ...
      {
        nomeSubquesito: "História do prato escolhido / Etnia",
        notaSubequesito: 2,
        quesitoId: culinaria.idQuesito,
      },
    ],
